...
public class WebClient {
	...
	public Event getEventById(int id) {
		...
		return (Event) call("getEventById", params, User.class);
	}
	...
	public List<Event> searchEvents(String somethingLikeThat) {
		Map<String, String> params = new HashMap<String, String>();		
		try {
			params.put("somethingLikeThat", mapper.writeValueAsString(somethingLikeThat));
		} catch (JsonGenerationException e) {
			e.printStackTrace();
			return null;
		} catch (JsonMappingException e) {
		...
		return (ArrayList<Event>) callGeneric("searchEvents", params, new TypeReference<ArrayList<Event>>() { });
	}
	...
	public List<Event> lookEventsAround(double longitude, double latitude,
		...
		return (ArrayList<Event>) callGeneric("lookEventsAround", params, new TypeReference<ArrayList<Event>>() { });
	}
	...
	public List<EventType> getEventTypes() {
		...
		return (ArrayList<EventType>) callGeneric("getEventTypes", params, new TypeReference<ArrayList<EventType>>() { });
	}
	...
	public List<User> searchUsers(String somethingLikeThat) {
		...
		return (ArrayList<User>) callGeneric("searchUsers", params, new TypeReference<ArrayList<User>>() { });
	}
	...
	private Object callGeneric(String nameMethod,
	...
	@SuppressWarnings("unchecked")
	private Object call(String nameMethod, Map<String, String> params, @SuppressWarnings("rawtypes") Class returnClass) {	
	...
	private String sendRequest(String nameMethod, Map<String, String> params) {
		...
		try {
			...
			BufferedReader responseDataBuff = new BufferedReader(new InputStreamReader(response.getEntity().getContent()));
			responseBody = "";
			String line = "";
